...
const dict = {
  ...
  signInSignUp: { en: "Sign In / Sign Up", ka: "შესვლა / რეგისტრაცია" },
  authHint: {
    en: "New email? An account will be created for you.",
    ka: "ახალი ელფოსტა? ანგარიში ავტომატურად შეიქმნება.",
  },
  checkEmail: { en: "Check your email to confirm your account", ka: "დაადასტურეთ ანგარიში ელფოსტიდან" },
  signedIn: { en: "Signed in", ka: "შესვლა შესრულდა" },
  signedOut: { en: "Signed out", ka: "გასვლა შესრულდა" },
  authError: { en: "Authentication failed", ka: "ავტორიზაცია ვერ შესრულდა" },
  loggedInAs: { en: "Signed in as", ka: "შესული ხართ როგორც" },
  logOut: { en: "Log Out", ka: "გასვლა" },
  about: { en: "About the app", ka: "აპლიკაციის შესახებ" },
  aboutText: {
    en: "Travel Expense Tracker. Created by Giorgi Jobava.",
    ka: "სამოგზაურო ხარჯების ტრეკერი. შექმნა გიორგი ჯობავამ.",
  },
