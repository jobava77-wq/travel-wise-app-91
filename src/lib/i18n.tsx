...
const dict = {
  ...
  manageCategories: { en: "Manage categories", ka: "კატეგორიების მართვა" },
  categoryName: { en: "Category name", ka: "კატეგორიის სახელი" },
  categoryNamePlaceholder: { en: "Shopping", ka: "შოპინგი" },
  categoryIcon: { en: "Icon", ka: "ხატულა" },
  addCategory: { en: "Add category", ka: "კატეგორიის დამატება" },
  categorySaved: { en: "Category saved", ka: "კატეგორია შენახულია" },
  noCustomCategories: { en: "No custom categories yet", ka: "მორგებული კატეგორიები ჯერ არ არის" },
